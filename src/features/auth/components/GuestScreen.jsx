...
const GuestScreenBase = {}

GuestScreenBase.Container = function Container({
  inputs,
  ...
  return (
    <View style="Content">
      ...
      <View style={styles.contentContainer} {...rest}>
        {isString(heading) ? (
          <GuestScreenBase.Heading>{heading}</GuestScreenBase.Heading>
        ) : (
          heading
        )}
        {isString(description) ? (
          <GuestScreenBase.Description>
            {description}
          </GuestScreenBase.Description>
        ) : (
          description
...
GuestScreenBase.Heading = function Heading({ children, style, ...rest }) {
  return (
...
GuestScreenBase.Description = function Description({
  children,
  style,
  ...rest
}) {
...
GuestScreenBase.SubmitButton = function SubmitButton({
  children,
  style,
  ...rest
}) {
...
GuestScreenBase.ScreenLink = function ScreenLink({ children, style, ...rest }) {
  return (
...
export default GuestScreenBase
